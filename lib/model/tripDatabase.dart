    ...
    TripItem(
      ...
      stepList: <StepItem>[
        ...
        StepItem(
          ...
          description:
              'Karol Wojtyła jako filozof dał się poznać jako przedstawiciel nurtu zwanego personalizmem. Dodatkowo w jego myśli da się odczytać wpływ myśli św. Tomasza z Akwinu. Personalizm, głoszony przez niego stawia człowieka i jego godność jako osoby za podstawę wszelkiej oceny moralnej. Człowiek najpełniej wyraża się w swoim świadomym i wolnym czynie (stąd tytuł znaczącej książki Wojtyły "Osoba i czyn"). Filozoficzna fascynacja człowiekiem jako posiadającym niezwykłą wartość, wpłynęła także w znacznym stopniu na teologiczne poglądy Karola Wojtyły. Placyk wybrukowany kamieniami w trzech kolorach: czarny - symbolizujący przeszłośc, biały - teraźniejszość, zielony - przyszłość.\n\nNa placyku po stronie zielonego bruku (przyszłości) znajduje się taboret (tron). Jest on stosunkowo wysoki, dlatego stojąc przy nim można poczuć się jak dziecko stojące przy taborecie dla osoby dorosłej. Aby usiąść na nim, trzeb się wspiąć albo podciągnąć. Jest to symboliczne ukazanie, iż do myśli Karola Wojtyły trzeba nam "dorastać", by ją w przyszłości móc w pełni zrozumieć.',
          previousStep: 12,
          nextStep: 14,
        ),
        StepItem(
